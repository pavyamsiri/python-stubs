...
def simps(y, x: Incomplete | None = None, dx: float = 1.0, axis: int = -1, even=...): ...
def simpson(y, *, x: Incomplete | None = None, dx: float = 1.0, axis: int = -1, even=...): ...
def cumulative_simpson(y, *, x: Incomplete | None = None, dx: float = 1.0, axis: int = -1, initial: Incomplete | None = None): ...
...
def qmc_quad(func, a, b, *, n_estimates: int = 8, n_points: int = 1024, qrng: Incomplete | None = None, log: bool = False): ...
