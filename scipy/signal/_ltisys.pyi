...
class lti(LinearTimeInvariant):
    ...
    def to_discrete(
        self, dt, method: str = "zoh", alpha: Incomplete | None = None
    ) -> None: ...
...
class dlti(LinearTimeInvariant):
    ...
    def bode(self, w: Incomplete | None = None, n: int = 100): ...
    def freqresp(
        self, w: Incomplete | None = None, n: int = 10000, whole: bool = False
    ): ...
...
def place_poles(
    A, B, poles, method: str = "YT", rtol: float = 0.001, maxiter: int = 30
): ...
...
def dfreqresp(
    system, w: Incomplete | None = None, n: int = 10000, whole: bool = False
): ...
