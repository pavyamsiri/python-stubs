...
class ShortTimeFFT:
    def __init__(self, win: np.ndarray, hop: int, fs: float, *, fft_mode: FFT_MODE_TYPE = 'onesided', mfft: int | None = None, dual_win: np.ndarray | None = None, scale_to: Literal['magnitude', 'psd'] | None = None, phase_shift: int | None = 0) -> None: ...
    @classmethod
    ...
    def spectrogram(self, x: np.ndarray, y: np.ndarray | None = None, detr: Callable[[np.ndarray], np.ndarray] | Literal['linear', 'constant'] | None = None, *, p0: int | None = None, p1: int | None = None, k_offset: int = 0, padding: PAD_TYPE = 'zeros', axis: int = -1) -> np.ndarray: ...
    @property
