...
def moment(a, order: int = 1, axis: int = 0, nan_policy: str = 'propagate', *, center: Incomplete | None = None): ...
...
class PearsonRResult(PearsonRResultBase):
    ...
    def confidence_interval(self, confidence_level: float = 0.95, method: Incomplete | None = None): ...

def pearsonr(x, y, *, alternative: str = 'two-sided', method: Incomplete | None = None): ...
...
def kendalltau(x, y, *, initial_lexsort=..., nan_policy: str = 'propagate', method: str = 'auto', variant: str = 'b', alternative: str = 'two-sided'): ...
...
class QuantileTestResult:
    ...
    pvalue: float
    def confidence_interval(self, confidence_level: float = 0.95): ...
    def __init__(self, statistic, statistic_type, pvalue, _alternative, _x, _p) -> None: ...

def quantile_test(x, *, q: int = 0, p: float = 0.5, alternative: str = 'two-sided'): ...
def wasserstein_distance_nd(u_values, v_values, u_weights: Incomplete | None = None, v_weights: Incomplete | None = None): ...
