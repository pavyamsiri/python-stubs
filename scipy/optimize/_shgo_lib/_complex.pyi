...
class Complex:
    ...
    def __init__(self, dim, domain: Incomplete | None = None, sfield: Incomplete | None = None, sfield_args=(), symmetry: Incomplete | None = None, constraints: Incomplete | None = None, workers: int = 1) -> None: ...
    def __call__(self): ...
    def cyclic_product(self, bounds, origin, supremum, centroid: bool = True) -> Generator[Incomplete, None, Incomplete]: ...
    origin: Incomplete
    supremum: Incomplete
    cp: Incomplete
    triangulated_vectors: Incomplete
    def triangulate(self, n: Incomplete | None = None, symmetry: Incomplete | None = None, centroid: bool = True, printout: bool = False) -> None: ...
    rls: Incomplete
    def refine(self, n: int = 1) -> None: ...
    def refine_all(self, centroids: bool = True) -> None: ...
    def refine_local_space(self, origin, supremum, bounds, centroid: int = 1) -> Generator[Incomplete, None, None]: ...
