...
def arange(start: int | float, /, stop: int | float | None = None, step: int | float = 1, *, xp, dtype: Dtype | None = None, device: Device | None = None, **kwargs) -> ndarray: ...
...
def eye(n_rows: int, n_cols: int | None = None, /, *, xp, k: int = 0, dtype: Dtype | None = None, device: Device | None = None, **kwargs) -> ndarray: ...
def full(shape: int | tuple[int, ...], fill_value: int | float, xp, *, dtype: Dtype | None = None, device: Device | None = None, **kwargs) -> ndarray: ...
def full_like(x: ndarray, /, fill_value: int | float, *, xp, dtype: Dtype | None = None, device: Device | None = None, **kwargs) -> ndarray: ...
def linspace(start: int | float, stop: int | float, /, num: int, *, xp, dtype: Dtype | None = None, device: Device | None = None, endpoint: bool = True, **kwargs) -> ndarray: ...
...
def std(x: ndarray, /, xp, *, axis: int | tuple[int, ...] | None = None, correction: int | float = 0.0, keepdims: bool = False, **kwargs) -> ndarray: ...
def var(x: ndarray, /, xp, *, axis: int | tuple[int, ...] | None = None, correction: int | float = 0.0, keepdims: bool = False, **kwargs) -> ndarray: ...
...
def sum(x: ndarray, /, xp, *, axis: int | tuple[int, ...] | None = None, dtype: Dtype | None = None, keepdims: bool = False, **kwargs) -> ndarray: ...
def prod(x: ndarray, /, xp, *, axis: int | tuple[int, ...] | None = None, dtype: Dtype | None = None, keepdims: bool = False, **kwargs) -> ndarray: ...
