...
def jensenshannon(p, q, base: Incomplete | None = None, *, axis: int = 0, keepdims: bool = False): ...
...
def is_valid_dm(D, tol: float = 0.0, throw: bool = False, name: str = 'D', warning: bool = False): ...
def is_valid_y(y, warning: bool = False, throw: bool = False, name: Incomplete | None = None): ...
def num_obs_dm(d): ...
def num_obs_y(Y): ...
def cdist(XA, XB, metric: str = 'euclidean', *, out: Incomplete | None = None, **kwargs): ...
